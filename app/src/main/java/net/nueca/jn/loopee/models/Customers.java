...
public class Customers {
    ...
    public final static String CUSTOMER_ID_FIELD_NAME = "id";
    public final static String CUSTOMER_CODE_FIELD_NAME = "code";
    public final static String CUSTOMER_FIRST_NAME_FIELD_NAME = "first_name";
    public final static String CUSTOMER_ALTERNATE_CODE_FIELD_NAME = "alternate_code";
    public final static String CUSTOMER_LAST_NAME_FIELD_NAME = "last_name";
    public final static String CUSTOMER_NAME_FIELD_NAME = "name";
    public final static String CUSTOMER_COMPANY_NAME_FIELD_NAME = "company_name";
    public final static String CUSTOMER_TIN_FIELD_NAME = "tin";
    public final static String CUSTOMER_TAX_EXCEMPT_FIELD_NAME = "tax_excempt";
    public final static String CUSTOMER_STREET_FIELD_NAME = "street";
    public final static String CUSTOMER_CITY_FIELD_NAME = "city";
    public final static String CUSTOMER_STATE_FIELD_NAME = "state";
    public final static String CUSTOMER_ZIPCODE_FIELD_NAME = "zipcode";
    public final static String CUSTOMER_COUNTRY_FIELD_NAME = "country";
    public final static String CUSTOMER_TELEPHONE_FIELD_NAME = "telephone";
    public final static String CUSTOMER_FAX_FIELD_NAME = "fax";
    public final static String CUSTOMER_MOBILE_FIELD_NAME = "mobile";
    public final static String CUSTOMER_EMAIL_FIELD_NAME = "email";
    public final static String CUSTOMER_REMARK_FIELD_NAME = "remark";
    public final static String CUSTOMER_CUSTOMER_TYPE_FIELD_NAME = "type";
    public final static String CUSTOMER_CUSTOMER_TYPE_NAME_FIELD_NAME = "type_name";
    public final static String CUSTOMER_DISCOUNT_TEXT_FIELD_NAME = "discount_text";
    public final static String CUSTOMER_AVAILABLE_POINTS_FIELD_NAME = "available_points";
    public final static String CUSTOMER_BIRTHDATE_FIELD_NAME = "birthdate";
    public final static String CUSTOMER_UTC_CREATED_AT_FIELD_NAME = "utc_created_at";
    public final static String CUSTOMER_UTC_UPDATED_AT_FIELD_NAME = "utc_updated_at";
    public final static String CUSTOMER_STATUS_FIELD_NAME = "status";
