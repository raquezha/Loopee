...
public class DatabaseConfigUtility extends OrmLiteConfigUtil{
    ...
    private static final Class<?>[] classes = new Class[]{ Session.class, Settings.class, Branches.class, Tax_Settings.class, Tax_Rates.class, Users.class, Products.class, Customers.class};
